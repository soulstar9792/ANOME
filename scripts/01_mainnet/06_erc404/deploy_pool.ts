...
const uniswapV2Router = '0x8cFe327CEc66d1C090Dd72bd0FF11d690C33a2Eb';
const uniswapV2PairHash = '0x57224589c67f3f30a6b0d7a1b54cf3153ab84563bc609ef41dfb34f8b2974d2d';
...
async function deployPoolFactory() {
  ...
  const factory = await FACTORY.deploy(addresses.usdt, paramReceivers, paramRatios);
