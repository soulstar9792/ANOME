...
import {IUniswapV2Router02} from "../../uniswap_v2/interfaces/IUniswapV2Router02.sol";
...
abstract contract ERC404UniswapV2Exempt is ERC404 {
    ...
    function _getUniswapV2Pair(address uniswapV2Factory_, address weth_) private view returns (address) {
